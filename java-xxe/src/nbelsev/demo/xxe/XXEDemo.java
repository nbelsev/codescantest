...
public class XXEDemo {
	...
	public static boolean validateXml(String xsdPath, String xmlPath) throws Exception {
		...
		validator.validate(new StreamSource(new File(xmlPath))); //Vulnerable to XXE
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Validation result 2: " + validateXml("GoodSchema.xsd", "BadXml.xml"));
